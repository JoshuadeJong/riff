...
mod imp {
    ...
    /// Inner GObject struct for the composite template defined in `details_header.blp`.
...
// =============================================================================
// DetailsHeader (public API wrapper)
// =============================================================================
...
impl DetailsHeader {
    ...
    pub fn set_subtitle_visible(&self, visible: bool) {
        self.widget.imp().subtitle_label.set_opacity(if visible { 1.0 } else { 0.0 });
    }
    ...
    // =========================================================================
    // Weak references (for async artwork loading)
    // =========================================================================
